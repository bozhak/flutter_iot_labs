...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _startMonitoring() {
    ...
    // Моніторинг MQTT-з'єднання
    _mqttService.connectionStream.listen((state) {
      if (mounted) {
        setState(() => _isMqttConnected = state == MqttConnectionState.connected);
      }
    });

    // Отримання даних з MQTT
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _isMqttConnected ? Colors.green.withOpacity(0.2) : Colors.red.withOpacity(0.2),
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: const Text('IoT Flutter Lab #4'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () {
                      showAboutDialog(
                        context: context,
                        ...
                        applicationLegalese: '© 2025 Лабораторна робота №4',
                        children: const [
                          SizedBox(height: 16),
                          Text(
                            'Додаток для моніторингу IoT-пристроїв через MQTT протокол з підтримкою автентифікації та перевірки інтернет-з\'єднання.',
                          ),
                        ],
                      );
                    },
